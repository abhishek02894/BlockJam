...
namespace UnityEngine.UI.Extensions
{
    ...
    {
        [Header("Scroll Snap End Event Settings")]
        public float scrollEndVelocityThreshold = 100;
        public float scrollEndDistanceThreshold = 25;
        private int lastEndExecutedOnPageNo = -1;
        ...
        void Update()
        {
            ...
            else if (_lerp)
            {
                ...
                if(_scroll_rect.velocity.magnitude <= scrollEndVelocityThreshold && 
                Vector3.Distance(_screensContainer.localPosition, _lerp_target) <= scrollEndDistanceThreshold &&
                lastEndExecutedOnPageNo != _currentPage)
                {
        ...
        {
            GameObject[] ChildrenRemoved = new GameObject[0];
            RemoveAllChildren(false, out ChildrenRemoved);
        }
